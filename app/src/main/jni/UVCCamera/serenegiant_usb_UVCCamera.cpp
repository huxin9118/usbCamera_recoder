...
static jint nativeSetPreviewDisplay(JNIEnv *env, jobject thiz,
	ID_TYPE id_camera, jobject jSurface, jint rotate) {

	jint result = JNI_ERR;
	ENTER();
	UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
	if (LIKELY(camera)) {
		LOGI("nativeSetPreviewDisplay() jSurface:%p!",jSurface);
		ANativeWindow *preview_window = jSurface ? ANativeWindow_fromSurface(env, jSurface) : NULL;
		LOGI("nativeSetPreviewDisplay() preview_window:%p!",preview_window);
		result = camera->setPreviewDisplay(preview_window, rotate);
	}
	RETURN(result, jint);
}
...
static JNINativeMethod methods[] = {
	...
	{ "nativeSetStatusCallback",		"(JLorg/uvccamera/usb/IStatusCallback;)I", (void *) nativeSetStatusCallback },
	{ "nativeSetButtonCallback",		"(JLorg/uvccamera/usb/IButtonCallback;)I", (void *) nativeSetButtonCallback },
	...
	{ "nativeSetPreviewDisplay",		"(JLandroid/view/Surface;I)I", (void *) nativeSetPreviewDisplay },
	{ "nativeSetFrameCallback",			"(JLorg/uvccamera/usb/IFrameCallback;I)I", (void *) nativeSetFrameCallback },
